...
export const positions = map(([lng, lat, comment]) => ({ lng, lat, comment }))([
  [-140.997, 69.6443, "Alaska-Yukon border at Beaufort Sea (QGIS)"],
  [-140.99697, 69.88835, "Alaska-Yukon border N point (QGIS)"],
  [
    -141.00172,
    60.30576,
    "South corner of NS line of Alaska-Yukon border (QGIS)",
  ],
  [-123.81132, 60.00103, "Intersection of BC, Yukon, NWT borders (QGIS)"],
  [-139.0536, 59.9943, "Intersection of BC, Yukon, Alaska borders (QGIS)"],
  [-120.00068, 60.00004, "Intersection of BC, NWT, Alberta borders (QGIS)"],
  [-110.00546, 59.999, "Intersection of Alberta, NWT, Sask borders (QGIS)"],

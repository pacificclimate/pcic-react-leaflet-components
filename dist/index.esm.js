...
var LabelsLayer = function LabelsLayer(_ref) {
  ...
  var map = useMap();
  useEffect(function () {
    var nonTiledLayer = L$1.nonTiledLayer.wms(wmsUrl, _objectSpread2(_objectSpread2({}, wmsOptions), {}, {
...
VectorGridLayer.propTypes = {
  ...
  crs: propTypes.exports.instanceOf(L$1.CRS).isRequired,

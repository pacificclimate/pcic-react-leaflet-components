...
var VectorGridLayer = function VectorGridLayer(_ref) {
  var tilesUrl = _ref.tilesUrl,
      vectorTileOptions = _ref.vectorTileOptions;
...
var _excluded$5 = ["tileset", "center", "zoom", "mapRef", "vectorTileOptions", "wmsUrl", "wmsLayerOptions", "children"];
...
var GenericVectorBaseMap = function GenericVectorBaseMap(_ref) {
  ...
  }, rest)), /*#__PURE__*/React__default["default"].createElement(reactLeaflet.WMSTileLayer, _extends({
    url: wmsUrl
  }, wmsLayerOptions)), children);
};
...
GenericVectorBaseMap.propTypes = {
  ...
  vectorTileOptions: propTypes.exports.object.isRequired,
...
var vectorTileStyling = {
  ...
  transportation: function transportation(properties, zoom) {
    ...
    if (transportationClass === 'tertiary' && zoom >= 10) return [{
      color: legend.Transportation.tertiary,
      weight: 1.2
    }];
    if (transportationClass === 'minor' && zoom > 11) return [{
      color: legend.Transportation.minor,
      weight: 1.1
    }];
    if (transportationClass === 'path' && zoom > 12) return [{
...
var _process$env = process.env,
    ...
    REACT_APP_LEGEND_TYPE = _process$env.REACT_APP_LEGEND_TYPE;
var wmsLayerOptions = {
  service: "WMS",

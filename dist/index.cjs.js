...
var LabelsLayer = function LabelsLayer(_ref) {
  ...
  React.useEffect(function () {
    var nonTiledLayer = new L__default["default"].nonTiledLayer.WMS(wmsUrl, _objectSpread2(_objectSpread2({}, wmsOptions), {}, {
      getImageUrl: function getImageUrl(bounds) {
        var _map$getSize = map.getSize(),
            width = _map$getSize.x,
            height = _map$getSize.y;
        ...
        return "".concat(wmsUrl, "?").concat(params.toString());
      }
    })).addTo(map);
    return function () {

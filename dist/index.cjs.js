...
var LabelsLayer = function LabelsLayer(_ref) {
  ...
  React.useEffect(function () {
    var wmsLayer = L__default["default"].tileLayer.wms(wmsUrl, {
      layers: 'omt_place',
      styles: '3005_place',
      format: 'image/png',
      transparent: true,
...
var VectorGridLayer = function VectorGridLayer(_ref2) {
  ...
  React.useEffect(function () {
    var vectorTileOptions = {
      rendererFactory: L__default["default"].svg.tile,
      interactive: true,
      buffer: BUFFER_SIZE,
    ...
    try {
      var vectorGrid = L__default["default"].vectorGrid.protobuf(tilesUrl, vectorTileOptions).on('click', function (e) {
        console.log('Clicked feature properties:', e.layer);
        L__default["default"].DomEvent.stopPropagation(e);

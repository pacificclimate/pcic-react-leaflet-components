...
proj4$1.Point = Point$2;
proj4$1.toPoint = common;
proj4$1.defs = defs;
...
var LabelsLayer = function LabelsLayer(_ref) {
  ...
  React.useEffect(function () {
    var nonTiledLayer = L__default["default"].nonTiledLayer.wms(wmsUrl, _objectSpread2(_objectSpread2({}, wmsOptions), {}, {
      getImageUrlAsync: function () {
        var _getImageUrlAsync = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(bounds) {
          var _map$getSize, width, height, sw, ne, bbox, params;

          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _map$getSize = map.getSize(), width = _map$getSize.x, height = _map$getSize.y;
                  ...
                  return _context.abrupt("return", "".concat(wmsUrl, "?").concat(params.toString()));
        ...
        function getImageUrlAsync(_x) {
          return _getImageUrlAsync.apply(this, arguments);
        }
...
var VectorGridLayer = function VectorGridLayer(_ref2) {
  ...
  React.useEffect(function () {
    var vectorTileOptions = {
      rendererFactory: L__default["default"].canvas.tile,
      interactive: false,
    ...
    try {
      var vectorGrid = L__default["default"].vectorGrid.protobuf(tilesUrl, vectorTileOptions).addTo(map);
      return function () {
...
VectorGridLayer.propTypes = {
  ...
  crs: propTypes.exports.instanceOf(L__default["default"].CRS).isRequired,
  wmsUrl: propTypes.exports.string.isRequired,
  wmsOptions: propTypes.exports.object.isRequired
};
...
var GenericVectorBaseMap = function GenericVectorBaseMap(_ref3) {
  var _ref3$tileset = _ref3.tileset,
      ...
      wmsUrl = _ref3.wmsUrl,
      wmsLayerOptions = _ref3.wmsLayerOptions,
  ...
  return /*#__PURE__*/React__default["default"].createElement(reactLeaflet.MapContainer, _extends({
    ...
    zoom: zoom,
    ref: mapRef
  }, rest), /*#__PURE__*/React__default["default"].createElement(VectorGridLayer, _extends({
    tilesUrl: url,
  ...
  }, rest)), /*#__PURE__*/React__default["default"].createElement(LabelsLayer, _extends({
    wmsUrl: wmsUrl,
    wmsOptions: wmsLayerOptions,
    crs: crs
  }, rest)), children);
...
GenericVectorBaseMap.propTypes = {
  ...
  wmsLayerOptions: propTypes.exports.shape({
    ...
    crs: propTypes.exports.instanceOf(L__default["default"].CRS)
  }).isRequired,
...
var vectorTileStyling = {
  ...
  landcover: function landcover(properties, zoom) {
    ...
    if (forestClasses.includes(landcoverClass) || forestClasses.includes(landcoverSubClass)) return [{
      color: legend.Landcover.forest,
      fill: true,
      fillOpacity: 1,
      weight: 0
    }];
    if (grassClasses.includes(landcoverClass)) return [{
      color: legend.Landcover.farmland,
      fill: true,
      fillOpacity: 1,
      weight: 0
    }];
    if (glacierClasses.includes(landcoverClass)) return [{
      color: legend.Landcover.glacier,
      fill: true,
      fillOpacity: 1,
      weight: 0
    }];
    if (landcoverClass === 'rock') return [{
      color: legend.Landcover.rock,
      fill: true,
      fillOpacity: 1,
      weight: 0
    }];
    if (landcoverClass === 'sand') return [{
  ...
  landuse: function landuse(properties, zoom) {
    ...
    if (residentialClasses.includes(landuseClass)) return [{
      color: legend.Landuse.residentialAndCommunity,
      fill: true,
      fillOpacity: 1,
      weight: 0
    }];
    if (commercialClasses.includes(landuseClass)) return [{
      color: legend.Landuse.commercialAndPublicServices,
      fill: true,
      fillOpacity: 1,
      weight: 0
    }];
    if (specialClasses.includes(landuseClass)) return [{
...
_defineProperty$1(BCVectorBaseMap, "tileset", {
  ...
  projection: {
    ...
    proj4def: '+proj=aea +lat_1=50 +lat_2=58.5 +lat_0=45 +lon_0=-126 +x_0=1000000 +y_0=0 +ellps=GRS80 +datum=NAD83 +units=m +no_defs',
    options: {
      transformation: new L__default["default"].Transformation(1, 0, -1, 0),
      project: function project(latlng) {
        var _proj4$forward = proj4(this.proj4def).forward([latlng.lng, latlng.lat]),
            x = _proj4$forward.x,
            y = _proj4$forward.y;

        return new L__default["default"].Point(x, y);
      },
      unproject: function unproject(point) {
        var _proj4$inverse = proj4(this.proj4def).inverse([point.x, point.y]),
            _proj4$inverse2 = _slicedToArray(_proj4$inverse, 2),
            lng = _proj4$inverse2[0],
            lat = _proj4$inverse2[1];

        return new L__default["default"].LatLng(lat, lng);
      }
    }
  },
  tileMatrix: {
...
exports.BCVectorBaseMap = BCVectorBaseMap;
exports.GenericBaseMap = GenericBaseMap;
exports.GenericVectorBaseMap = GenericVectorBaseMap;

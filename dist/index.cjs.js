...
var _excluded$5 = ["tileset", "center", "zoom", "mapRef", "children"];
  ...
  _createClass(BCBaseMap, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          baseMapTilesUrl = _this$props.baseMapTilesUrl,
...
var _excluded$2 = ["url", "style", "attribution", "onError"];
...
function EEZLayer(_ref) {
  var url = _ref.url,
      ...
      geoJSONProps = _objectWithoutProperties(_ref, _excluded$2);
  ...
  React.useEffect(function () {
    ...
    fetch(url, {
      ...
      if (!response.ok) {
        throw new Error("Failed to fetch EEZ GeoJSON: ".concat(response.status, " ").concat(response.statusText));
      }
  ...
  return data ? /*#__PURE__*/React__default["default"].createElement(reactLeaflet.GeoJSON, _extends({
    data: data,
...
var WeakMap$1 = getNative$4(root$9, 'WeakMap');

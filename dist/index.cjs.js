...
function VectorTileLayer(_ref) {
  ...
  React.useEffect(function () {
    axios__default["default"].get(styleUrl).then(function (response) {
      var style = response.data;
      var vectorGridLayer = L__default["default"].vectorGrid.protobuf(url, {
        attribution: attribution,
        interactive: true,
...
function GenericVectorBaseMap(_ref2) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(reactLeaflet.MapContainer, _extends({
    ...
    zoom: zoom,
    ref: mapRef
  }, rest), /*#__PURE__*/React__default["default"].createElement(VectorTileLayer, {
    url: url,
    styleUrl: styleUrl,
    attribution: attribution
  }), children);

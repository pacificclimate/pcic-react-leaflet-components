...
var LabelOverlay = function LabelOverlay(_ref) {
  ...
  React.useEffect(function () {
    ...
    var transformedBBOX = "".concat(sw.x, ",").concat(sw.y, ",").concat(ne.x, ",").concat(ne.y);
    var labelUrl = "".concat(wmsUrl, "?SERVICE=WMS&VERSION=").concat(wmsOptions.version, "&REQUEST=GetMap&LAYERS=").concat(wmsOptions.layers, "&STYLES=&FORMAT=image/svg+xml&TRANSPARENT=").concat(wmsOptions.transparent, "&WIDTH=256&HEIGHT=256&BBOX=").concat(transformedBBOX, "&CRS=").concat(wmsOptions.crs.code);
    var labelOverlay = L__default["default"].imageOverlay(labelUrl, map.getBounds(), {}).addTo(map);
    return function () {
...
var GenericVectorBaseMap = function GenericVectorBaseMap(_ref3) {
  ...
  }, rest)), /*#__PURE__*/React__default["default"].createElement(LabelOverlay, {
    wmsUrl: wmsUrl,
    wmsOptions: wmsLayerOptions,
    center: center,
    zoom: zoom,
  ...
  _createClass(BCVectorBaseMap, [{
    ...
    value: function render() {
      ...
      var wmsLayerOptions = {
        ...
        version: '1.1.0',
        crs: {
          obj: L__default["default"].CRS.EPSG3005,
          code: 'EPSG:3005'
        }
      };

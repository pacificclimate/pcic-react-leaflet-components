...
react = __toESM(react);
let react_leaflet = require("react-leaflet");
let leaflet = require("leaflet");
leaflet = __toESM(leaflet);
require("leaflet/dist/leaflet.css");
let react_jsx_runtime = require("react/jsx-runtime");
let react_dom_client = require("react-dom/client");
let _react_leaflet_core = require("@react-leaflet/core");
...
function projCRSOptions(tileMatrixParams) {
	...
	return {
		bounds: leaflet.default.bounds(leaflet.default.point(tileMatrixMinX, tileMatrixMinY), leaflet.default.point(tileMatrixMaxX, tileMatrixMaxY)),
...
function GenericBaseMap(_ref) {
	...
	const crs = new leaflet.default.Proj.CRS(projection.code, projection.proj4def, _objectSpread2(_objectSpread2({}, projCRSOptions(tileMatrix)), projection.options));
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_leaflet.MapContainer, _objectSpread2(_objectSpread2({
		crs,
		minZoom: 0,
		maxZoom: tileMatrix.numResolutions,
		center,
		zoom
	}, rest), {}, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_leaflet.TileLayer, {
		attribution,
		url,
		noWrap: true,
		maxZoom: tileMatrix.numResolutions
...
var BCBaseMap = class BCBaseMap extends react.PureComponent {
	render() {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GenericBaseMap, _objectSpread2(_objectSpread2({ tileset }, rest), {}, { children }));
	}
};
...
var YNWTBaseMap = class YNWTBaseMap extends react.PureComponent {
	render() {
...
function EEZLayer(_ref) {
	...
	return data ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_leaflet.GeoJSON, _objectSpread2({
		data,
...
var SetView = ({ view, debug = false }) => {
	const map = (0, react_leaflet.useMap)();
...
leaflet.default.Control.Static = leaflet.default.Control.extend({
	onAdd: (map) => {
		return leaflet.default.DomUtil.create("div", "leaflet-control-static leaflet-control");
	},
	onRemove: (map) => {}
});
leaflet.default.control.static = (opts) => new leaflet.default.Control.Static(opts);
//#endregion
...
function StaticControl(_ref) {
	...
	const context = (0, _react_leaflet_core.useLeafletContext)();
	(0, react.useEffect)(() => {
		const control = leaflet.default.control.static(rest);
		control.addTo(context.map);
		(0, react_dom_client.createRoot)(control.getContainer()).render(children);
		return () => {
			control.remove();
		};
	});
...
function MapSpinner(_ref) {
	...
	const [bounds, setBounds] = (0, react.useState)((0, react_leaflet.useMap)().getBounds());
	const onEvent = (map) => setBounds(map.getBounds());
	const map = (0, react_leaflet.useMapEvents)({
		zoomend: () => onEvent(map),
		moveend: () => onEvent(map)
	});
	const Spinner = import_dist[spinner];
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_leaflet.SVGOverlay, {
		bounds,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Spinner, _objectSpread2({
			x,
			y,
			stroke
		}, rest))
...
var callbackOnMapEvents = (eventNames, callback) => {
	return () => {
		const leafletMap = (0, react_leaflet.useMapEvents)((0, import_flow.default)((0, import_map.default)((name) => [name, () => {
			callback(leafletMap);
...
exports.defaultEEZAttribution = defaultEEZAttribution;
exports.defaultEEZGeoJSONUrl = defaultEEZGeoJSONUrl;
